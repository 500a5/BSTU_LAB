...
void Init_I2C_custom_speed()
{
  ...
  U0CTL &= ~I2CEN;         // Выключить модуль I2C
// Конфигурация модуля I2C
  I2CTCTL=I2CSSEL_2;      // Используем SMCLK = 8 МГц
  // Необходимо получить частоту 20 кГц.
  // Прескалер не стоит выставлять больше 4
  I2CPSC = 0x03;          // Прескалер
  // I2CSCLH = I2CSCLL = 99 = 63h
  I2CSCLH = 0x63;         // Высокий уровень SCL: (I2CPSC+1)(I2CSCLH+1)
  I2CSCLL = 0x63;         // Низкий уровень SCL (I2CPSC+1)(I2CSCLH+1)
