...
int * init_posl(int);
int is_gam_graf(int **, int, int);
int find_gam_cikl(int, int, int);
int is_smezh_ver(int, int, int);
int ** get_memory_matr(int, int);
void free_memory(int **, int);
void clear_matr(int **, int, int);
void init_matr_rand_numbers(int **, int, int);
void ten_sec_gen(int, int);
void output_graf(int **, int, int);
int is_eil_graf(int **, int, int);
int is_gam_graf(int **, int, int);
int is_sviaz(int **, int, int);
...
// Вывод графа
void output_graf(int **a, int n, int m) {
	int i, j;
