...
void output(int m, int n, int **table)
{
	...
	for (int i = 0; i < n; i++)
	{
		...
		//cout << F(table[i]) << "     ";
		cout << R(F(table[i]), f10(table[i][0], table[i][1], table[i][2], table[i][3], table[i][4])) << "     ";
		cout << R(F(table[i]), f11(table[i][0], table[i][1], table[i][2], table[i][3], table[i][4])) << "     ";
		cout << R(F(table[i]), f20(table[i][0], table[i][1], table[i][2], table[i][3], table[i][4])) << "     ";
		cout << R(F(table[i]), f21(table[i][0], table[i][1], table[i][2], table[i][3], table[i][4])) << "     ";
		cout << R(F(table[i]), f30(table[i][0], table[i][1], table[i][2], table[i][3], table[i][4])) << "     ";
		cout << R(F(table[i]), f31(table[i][0], table[i][1], table[i][2], table[i][3], table[i][4])) << "     ";
		cout << R(F(table[i]), f40(table[i][0], table[i][1], table[i][2], table[i][3], table[i][4])) << "     ";
		cout << R(F(table[i]), f41(table[i][0], table[i][1], table[i][2], table[i][3], table[i][4])) << "     ";
		cout << R(F(table[i]), f50(table[i][0], table[i][1], table[i][2], table[i][3], table[i][4])) << "     ";
		cout << R(F(table[i]), f51(table[i][0], table[i][1], table[i][2], table[i][3], table[i][4])) << "     ";
		cout << endl;
	}
}
