/****************************************************************************
** Meta object code from reading C++ file 'blockcells.h'
**
...
#error "The header file 'blockcells.h' doesn't include <QObject>."
...
const QMetaObject NonEditTableColumnDelegate::staticMetaObject = {
    { &QItemDelegate::staticMetaObject, qt_meta_stringdata_NonEditTableColumnDelegate.data,
      qt_meta_data_NonEditTableColumnDelegate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *NonEditTableColumnDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NonEditTableColumnDelegate.stringdata0))
        return static_cast<void*>(const_cast< NonEditTableColumnDelegate*>(this));
